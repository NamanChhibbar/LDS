...
In our experiments, we find that segmentation is a crucial step in the pipeline and can influence the output summary greatly, indicating that good segmentation is important for good distillation of text.
...
Future work may also be focused on extending the Summarization with Keyword Extraction (\autoref{method:keyword}) method.
...
Our experiments show significant improvement in BERTScore compared to Unlimiformer \cite{bertsch2023unlimiformer} on the GovReport dataset.
